package com.allteran.deliverer.util;
...
public final class Const {
    ...
    public static final String ID_ORDER_FORMED="order_status_formed";
    ...
    public static final String ORDER_STATUS_FORMED="Заказ сформирован";
